...
| 1.0.6   | 2026-02-27     | - Bumped `@storybook/nextjs-vite` from `10.2.9` to `10.2.13` in Frontend Directory. <br /> - Updated `minimatch` to `10.2.3` for resolving [`CVE-2026-27903`](https://vulners.com/cve/CVE-2026-27903) & [`CVE-2026-27904`](https://vulners.com/cve/CVE-2026-27904). <br /> - Bumped `tailwindcss` from `4.2.0` to `4.2.1`. <br /> - Bumped `react-hook-form` from `7.71.1` to `7.71.2`. <br /> - Bumped `expo-status-bar` from `3.0.9` to `55.0.4`. <br /> - Bumped `react-native-screens` from `4.23.0` to `4.24.0`. <br /> - Bumped `@chromatic-com/storybook` from `4.1.3` to `5.0.1`.                                                                                                                  | @corebit-bd |
| 1.0.7   | 2026-03-04     | Fixed CI Security by hardening Trivy SARIF Generation to avoid transient Registry Rate-Limits by using the Trivy DB ECR Mirror (`public.ecr.aws/...`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | @corebit-bd |
| 1.0.8   | 2026-03-07     | - Bumped `react-native-safe-area-context` from `5.6.2` to `5.7.0` in `/mobile`. <br /> - Bumped `axios` from `1.13.5` to `1.13.6` in `/frontend`. <br /> - Bumped `react-native` from `0.84.0` to `0.84.1` in `/mobile`. <br /> - Bumped `@storybook/addon-docs` from `10.2.9` to `10.2.15` in `/frontend`. <br /> - Bumped `@react-navigation/native` from `7.1.31` to `7.1.33`in `/mobile`. <br /> - Bumped `tailwind-merge` from `3.4.1` to `3.5.0` in `/frontend`. <br /> - Bumped `@react-navigation/stack` from `7.8.2` to `7.8.4` in `/mobile`. <br /> - Bumped `storybook/nextjs-vite` from `10.2.13` to `10.2.15` in `/frontend`. <br /> - Bumped `expo` from `54.0.33` to `55.0.5` in `/mobile`. | @corebit-bd |
