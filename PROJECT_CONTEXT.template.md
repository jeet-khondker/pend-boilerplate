...
| 1.0.8   | 2026-03-07     | - Bumped `react-native-safe-area-context` from `5.6.2` to `5.7.0` in `/mobile`. <br /> - Bumped `axios` from `1.13.5` to `1.13.6` in `/frontend`. <br /> - Bumped `react-native` from `0.84.0` to `0.84.1` in `/mobile`. <br /> - Bumped `@storybook/addon-docs` from `10.2.9` to `10.2.15` in `/frontend`. <br /> - Bumped `@react-navigation/native` from `7.1.31` to `7.1.33`in `/mobile`. <br /> - Bumped `tailwind-merge` from `3.4.1` to `3.5.0` in `/frontend`.                                                                                                                    | @corebit-bd |
