...
| 1.0.6   | 2026-02-27     | - Bumped `@storybook/nextjs-vite` from `10.2.9` to `10.2.13` in Frontend Directory. <br /> - Updated `minimatch` to `10.2.3` for resolving [`CVE-2026-27903`](https://vulners.com/cve/CVE-2026-27903) & [`CVE-2026-27904`](https://vulners.com/cve/CVE-2026-27904). <br /> - Bumped `tailwindcss` from `4.2.0` to `4.2.1`. | @corebit-bd |
